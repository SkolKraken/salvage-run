...
function startDrone(ac: AudioContext, out: GainNode): void {
  ...
  const mk = (type: OscillatorType, freq: number, detune: number): void => {
...
function schedulePad(ac: AudioContext, out: GainNode): void {
  const loop = (): void => {
...
function scheduleThuds(ac: AudioContext, out: GainNode): void {
